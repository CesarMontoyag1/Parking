...
export default function PanelLayout({ children }: { children: React.ReactNode }) {
  ...
  const menuItems = [
    { label: 'Inicio', href: '/panel', icon: 'M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6' },
    { label: 'Gestión', href: '/panel/admin#gestion', icon: 'M8 7h12m0 0l-4-4m4 4l-4 4m0 6H4m0 0l4 4m-4-4l4-4' },
    { label: 'Vigilantes', href: '/panel/admin#vigilantes', icon: 'M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z' },
          ...
          {menuItems.map((item) => (
            <Link 
              ...
              className={`flex items-center gap-4 rounded-xl px-4 py-4 transition-all ${
                pathname === item.href ? 'bg-white text-black' : 'text-gray-500 hover:bg-white/5 hover:text-white'
              }`}
            >
