        ...
        <div className="container mx-auto flex flex-col gap-12 px-8">
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
            <div className="rounded-3xl border border-gray-200 bg-gray-50 p-6">
              ...
              <p className="mt-3 text-gray-700">Generación de comprobantes digitales para mayor formalidad y transparencia.</p>
            </div>
            <div className="rounded-3xl border border-gray-200 bg-gray-50 p-6">
              <h4 className="text-lg font-bold">Modo multi-sede</h4>
              <p className="mt-3 text-gray-700">Gestión centralizada o independiente de múltiples ubicaciones.</p>
            </div>
            <div className="rounded-3xl border border-gray-200 bg-gray-50 p-6">
              <h4 className="text-lg font-bold">Notificaciones inteligentes</h4>
              <p className="mt-3 text-gray-700">Alertas automáticas al alcanzar umbrales de ocupación.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="unetenos" className="bg-black py-24 text-white">
        <div className="container mx-auto grid grid-cols-1 items-center gap-12 px-8 md:grid-cols-2">
          <div>
            ...
            <h3 className="mt-4 text-4xl font-black uppercase leading-none md:text-5xl">Empieza hoy con 3 días gratis.</h3>
            <p className="mt-6 text-lg leading-relaxed text-gray-300">
              Crea tu cuenta y configura tu empresa en minutos. También puedes registrarte con Google.
            </p>
          </div>
          <div className="rounded-3xl border border-white/10 bg-white/5 p-10">
            <p className="text-sm font-bold uppercase tracking-[0.3em] text-gray-400">Acceso inmediato</p>
            <p className="mt-4 text-lg text-gray-200">
              Activa tu trial, crea tu sede principal y comienza a administrar vigilantes desde el panel.
            </p>
            <div className="mt-8 flex flex-wrap gap-3">
              <Link
                href="/prueba-gratis"
                className="inline-flex items-center justify-center border border-white bg-white px-8 py-3 text-sm font-bold tracking-widest text-black transition-colors hover:bg-transparent hover:text-white"
              >
                EMPEZAR GRATIS
              </Link>
              <Link
                href="/planes"
                className="inline-flex items-center justify-center border border-white px-8 py-3 text-sm font-bold tracking-widest transition-colors hover:bg-white hover:text-black"
              >
                VER PLANES
              </Link>
            </div>
