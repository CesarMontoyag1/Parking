    ...
    <nav className="sticky top-0 z-50 w-full border-b border-white/10 bg-black/80 backdrop-blur-md">
      ...
      <div className="container mx-auto flex items-center justify-between px-6 py-4">
        ...
        <div className="hidden space-x-8 md:flex">
          ...
          <a href="#carrusel" className="text-sm font-medium transition-colors hover:text-gray-400">
            Demostración
          </a>
        ...
        <div className="flex space-x-4">
          <button className="rounded-md border border-white px-5 py-2 text-sm font-medium transition-colors hover:bg-white hover:text-black">
            Iniciar Sesión
          </button>
        </div>
      </div>
